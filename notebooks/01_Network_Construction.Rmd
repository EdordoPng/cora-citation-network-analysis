...
# Indice : 01_Network_Construction.Rmd: 
  ...
  A : Qual è il numero di paper in ogni categoria ?
  B : Qual è la distribuzione del numero di citazioni fatte dai paper ?
  C : Per ogni catgoria, quante sono le citazioni verso la stessa categoria ?

  8 : Salvataggio oggetti per analisi successive
...
Se non va, prova a chiamare da terminale "../scripts/01_download_data.R" dopo aver aperto il progetto in RStudio.
...
## Domanda A : Qual è il numero di paper in ogni categoria ? 
...
## Domanda B : Qual è la distribuzione del numero di citazioni fatte dai paper ?
...
## Domanda C : Per ogni catgoria, quante sono le citazioni verso la stessa categoria ? 
